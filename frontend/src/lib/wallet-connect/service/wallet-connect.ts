...
} from "@/lib/wallet-connect/config/EIP155";
import { EthEvent, WCChains } from "@/lib/wallet-connect/config/common";
...
export enum WCEvent {
  ...
  EthSignTypedData = EIP155Method.SignTypedDataV4,
...
export type EthSignTypedDataEventPayload = {
  params: any;
  origin: string;
...
case EIP155Method.SignTypedData:
      ...
      case EIP155Method.SignTypedDataV4:
        this.emit(WCEvent.EthSignTypedData, {
          params: params,
          origin,
          onSuccess,
          onReject,
        } as EthSignTypedDataEventPayload);
        return null;
