...
export default function MerchantIntegrationPage() {
  ...
  return (
    <div className='flex-1 space-y-4 p-6'>
      ...
      <div className='max-w-3xl grid gap-6 xl:grid-cols-[1.2fr_1fr]'>
          ...
          <div className='mt-4 space-y-3 text-sm'>
            ...
            <div className='flex items-start gap-3 rounded-lg border border-border/40 bg-background/50 p-3'>
              ...
              <div>
                ...
                <code className='mt-1 block rounded bg-muted/50 px-2 py-1 text-[11px]'>
      ...
      <div className='max-w-3xl rounded-xl border border-border/60 bg-card/50 backdrop-blur p-6'>
        ...
        <div className='mt-4 space-y-2'>
          {(state?.events || []).slice(0, 12).map((event) => (
            <div key={event.id} className='rounded-lg border border-border/40 bg-background/50 px-3 py-2 text-xs'>
